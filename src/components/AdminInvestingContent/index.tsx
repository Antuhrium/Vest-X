        ...
        <>
            ...
            <div className={styles.analitics}>
                <div className={styles.analiticsItem}>
                    <div className={styles.vestingTopInfo}>
                        Number of investors:
                    </div>
                    <span className={styles.vestingTopInfo}>234</span>
                </div>
                <div className={styles.analiticsItem}>
                    <div className={styles.analiticsInfo}>
                        Have vesting begun:
                    </div>
                    <span
                        className={styles.analiticsInfo}
                        style={{ color: "#29E185" }}
                    >
                        Vesting open
                    </span>
