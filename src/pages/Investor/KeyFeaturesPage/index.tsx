...
const PhoneSizedKeyFeaturesPage: React.FC = () => {
	...
	return (
		<div
			className={`${styles.wrapper} flex lg:hidden w-full min-h-screen text-white text-[18px] gap-3 py-1 px-3 pb-24 mt-6`}
		>
			{tab === 0 && (
				<>
					<div
			...
			{tab === 1 && (
				<>
					...
					>
						<img
							src={ArrowBack}
							className="w-4 h-4 mr-2 text-[14px]"
							alt="arrow back"
						/>
						Back to Key Features and Highlights
					</span>
					<CurrentBackers
